...
export const InstagramIcon = ({ size = 20, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 2.67.121 3.985 1.436 4.106 4.106.056 1.265.071 1.647.071 4.85 0 3.203-.016 3.585-.071 4.85-.121 2.67-1.436 3.985-4.106 4.106-1.265.056-1.647.071-4.85.071-3.203 0-3.585-.016-4.85-.071-2.67-.121-3.985-1.436-4.106-4.106-.056-1.265-.071-1.647-.071-4.85 0-3.203.016-3.585.071-4.85.121-2.67 1.436-3.985 4.106-4.106 1.265-.056 1.647-.071 4.85-.071zM12 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" />
  </svg>
);
