...
export default function EditProjectPage() {
  ...
  const onSubmit = (data: ProjectFormValues) => {
    updateMutation.mutate(
      ...
      {
        onSuccess: () => router.push('/dashboard/my-projects'),
      }
    );
  };
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6 p-4 text-right lg:p-8">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight">تعديل المشروع</h1>
      </div>
            ...
            <CardContent className="space-y-8 pt-8">
              <div className="grid gap-3">
                ...
                <Input
                  id="title"
                  {...register('title')}
                  className="bg-background/50 border-muted h-14 focus:border-teal-500/50"
                />
                {errors.title && (
              ...
              <div className="grid gap-3">
                ...
                <Textarea
                  ...
                  className="bg-background/50 border-muted min-h-[150px] focus:border-teal-500/50"
                />
                {errors.description && (
                  <span className="text-destructive text-xs">
              ...
              <div className="flex flex-col gap-1">
                ...
                {errors.milestones && (
                  <span className="text-destructive text-xs font-medium">
                    {errors.milestones.message || (errors.milestones as any).root?.message}
                  </span>
                )}
              </div>
              <Button
              ...
              {fields.map((field, index) => (
                ...
                >
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        className="bg-card ring-muted/20 border-none ring-1"
                      />
                    </div>
                    <div className="relative grid gap-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="bg-card ring-muted/20 border-none pr-8 ring-1"
                        />
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="bg-background text-destructive absolute -top-3 -left-3 h-8 w-8 rounded-full border shadow-sm"
              ...
              <div className="space-y-4 text-center">
                ...
                <div className="group relative">
                  ...
                  <Input
                    ...
                    className="h-24 border-none bg-transparent p-0 text-center text-6xl font-black transition-all hover:scale-105 focus:ring-0"
                  />
                </div>
              </div>
              ...
              >
                {updateMutation.isPending ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>تحديث المشروع وحفظ التغييرات</span>
                  </div>
                )}
              </Button>
              <Button
                type="button"
                variant="link"
                className="text-muted-foreground w-full transition-colors hover:text-teal-500"
              >
                <Link href="/dashboard/projects">إلغاء التعديلات والعودة</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
